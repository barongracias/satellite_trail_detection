...
The locked Hough path (src/classical/hough_runner.py, scripts/hough_postprocess.py)
...
sys.path.insert(0, str(Path(__file__).parent.parent))   # repo root (src.*, scripts.*)
...
from scripts.hough_postprocess import (
    _HOUGH_MAX_BATCH,
    _PATCH_SIZE,
    _apply_hough,
    _chunks,
