...
validation-only screen over multipliers $\{0.5, 1.0, 2.0\}$ yielded no
validation-$F_1$ gain meeting the preregistered adoption criterion, so the
setting is a robustness choice rather than a tuned gain.
