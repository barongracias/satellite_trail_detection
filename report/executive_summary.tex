...
reference. Paper-reference markers are shown only for the explicitly reported
precision and recall values; recall is closely reproduced while strict precision
remains lower, motivating the boundary-scale error analysis.}
...
selection of test-patch predictions for the locked U-Net: ground truth in green,
