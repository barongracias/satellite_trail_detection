...
rather than genuine false detection (Figure~\ref{fig:supp_hough_thickness}). With the canvas reconstructed from patches
rather than dense full-frame inference (Section~\ref{sec:hough}), this is
comparable completeness, not superiority. The same discipline applies to the tolerant
...
\begin{itemize}
  \item \textbf{Mask undercapture.} The annotations occasionally undercover
        ...
        bound where the labels undercover. The re-annotation audit of
