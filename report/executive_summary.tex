...
strict-precision gap is mostly boundary-near. The appropriate reporting
standard is therefore strict precision/recall plus a boundary-tolerant operating
...
granularity rather than detector error. A labelled cross-instrument test,
